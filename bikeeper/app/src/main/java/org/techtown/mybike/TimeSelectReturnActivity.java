...
public class TimeSelectReturnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_time_select_return);
        ...
        ArrayAdapter<String> Madapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,Imonth);
        Madapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        month.setAdapter(Madapter);

        ArrayAdapter<String> Dadapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,Idate);
        Dadapter.setDropDownViewResource(android.R.layout.simple_dropdown_item_1line);
        date.setAdapter(Dadapter);

        ArrayAdapter<String> Tadapter = new ArrayAdapter<String>(this,android.R.layout.simple_spinner_item,Itime);
        ...
        okay.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent ok = new Intent(TimeSelectReturnActivity.this,CompleteReturnActivity.class);
                startActivity(ok);
            }
        });
